 ...
 * For example, in an array of length 5, the majority element must appear more than
 * floor(5/2) = 2 times. This property ensures that a majority element will dominate the
 ...
 * 3. The `count` is incremented if the current element matches the `majorityElement`
 *    and decremented otherwise.
 * 4. At the end of the loop, the `majorityElement` is guaranteed to be the element that
 *    appears the most, based on the problem's constraints.
 *
 * Assumptions:
